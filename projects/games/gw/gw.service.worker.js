...
/** @type {string} */
const CACHE_VERSION = '1725910709|42578124244';
/** @type {string} */
const CACHE_PREFIX = 'Garbageworld-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'gw.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["gw.html","gw.js","gw.offline.html","gw.icon.png","gw.apple-touch-icon.png","gw.worker.js","gw.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["gw.wasm","gw.pck","gw.side.wasm"];
